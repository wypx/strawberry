...
func (executor *ModifyDiskImageExecutor) Execute(id vm_utils.SessionID, request vm_utils.Message,
	...
	var result = <-respChan
	resp, _ := vm_utils.CreateJsonMessage(vm_utils.ModifyDiskImageResponse)
