...
func (executor *EjectMediaExecutor) Execute(id vm_utils.SessionID, request vm_utils.Message,
	...
	resp, _ := vm_utils.CreateJsonMessage(vm_utils.EjectMediaResponse)
	...
	{
		//forward request
		forward, _ := vm_utils.CreateJsonMessage(vm_utils.EjectMediaRequest)
