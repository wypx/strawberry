...
func (executor *CreateStoragePoolExecutor) Execute(id vm_utils.SessionID, request vm_utils.Message,
	...
	resp, _ := vm_utils.CreateJsonMessage(vm_utils.CreateStoragePoolResponse)
