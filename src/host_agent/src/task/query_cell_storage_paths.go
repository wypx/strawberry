...
func (executor *QueryStoragePathsExecutor) Execute(id vm_utils.SessionID, request vm_utils.Message,
	...
	resp, _ := vm_utils.CreateJsonMessage(vm_utils.QueryCellStorageResponse)
