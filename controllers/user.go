...
func (a *User) Login(c *gin.Context) {
	if c.Request.Method == "GET" {
		c.HTML(http.StatusOK, "remark/static/login/login.html", gin.H{
			"title": "登录",
		})
...
func (a *User) LockSess(c *gin.Context) {
	if c.Request.Method == "GET" {
		c.HTML(http.StatusOK, "remark/static/login/lockscreen.html", gin.H{
			"message": "",
		})
	} else if c.Request.Method == "POST" {
		username := c.Request.PostFormValue("Username")
...
func (a *User) Register(c *gin.Context) {
	if c.Request.Method == "GET" {
		c.HTML(http.StatusOK, "remark/static/login/register.html", gin.H{
			"message": "",
		})
	} else if c.Request.Method == "POST" {
		username := c.Request.PostFormValue("username")
